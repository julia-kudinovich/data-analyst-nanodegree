SELECT DISTINCT
dp.scode 'Property',
rtrim(at.subgroup10) as 'Division', 
rtrim(at.subgroup18) as 'Region', 
rtrim(at.subgroup9) as 'District', 
rtrim(at.subgroup12) as 'Market',
...
mv.saddr1 'Vendor Address', 
mv.saddr2 'Vendor Address 2',
mv.scity 'Vendor City',
mv.sstate 'Vendor State',
mv.szipcode 'Vendor zip',
mv.sphonenum0 'Vendor Phone #',
mv.semail 'Vendor Email',
...
and rtrim((SELECT at2.spropname FROM yardi_stage.dbo.attributes at2 WHERE at.subgroup14 = at2.scode)) like '%roman%'
